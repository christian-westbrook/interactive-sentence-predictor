...
public class Predictor {
	...
	public Predictor(HashMap<String, Integer> unigrams, HashMap<String, Integer> bigrams,
			HashMap<String, Integer> trigrams, HashMap<String, Integer> misc) {
	...
	public Node unigramMLE() {
		...
		while (i.hasNext()) {
			...
			log = Math.log10((double) unigrams.get(s) / unigrams.size());
	...
	// ===========================================================================================================
	// Calculate bigram MLE from a single word input. This is called after the input from Voce is split
	...
	public Node bigramMLE(String first) {
		...
		while (i.hasNext()) {
			...
			if (s.matches(first + " .+")) {
				...
				e = s.split(" ")[1];
				log = Math.log10(((double) bigrams.get(s) + 1) / (unigrams.get(e) + unigrams.size()));
	...
	// ===========================================================================================================
	// Calculate trigram MLE from a single word input. This is called after the input from Voce is split
	// into fragments we can use.
	// ===========================================================================================================
